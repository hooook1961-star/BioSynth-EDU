...
with tab3:
    ...
    Наша модель Случайного Леса, обученная на базе данных **PDBbind Core Set**, 
    ...
    with pocket_col2:
        if st.session_state.get('pocket_analyzed'):
            ...
            st.caption("Ожидание запуска анализа... Нажмите кнопку слева, чтобы применить обученный Случайный Лес.")
