...
with tab5:
    ...
    **Задание по органической химии для студентов**
    Выполните задание и исследуйте лекарственное или биологически активное соединение. 
    👈 Чтобы приступить, выберите соединение или введите его SMILES в боковой панели
    """)
