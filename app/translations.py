...
LANGUAGES = {
    "Русский": {
        ...
        """,
        "docking_stage2_title": "🎯 Поиск биологической мишени в базе scPDB",
        ...
        "spinner_screening": "Проводится побитовое сравнение со структурами 17 188 лигандов scPDB...",
        ...
        "top_match_instruction": "💡 *Инструкция для студента:* Ваша молекула наиболее похожа на нативный лиганд этого белка. Возьмите из архива scPDB папку `{pdb_id}` — там уже подготовлены координаты кармана для проведения молекулярного докинга.",
    ...
    "Қазақша": {
        ...
        """,
        "docking_stage2_title": "🎯 scPDB дерекқорынан биологиялық нысананы іздеу",
        ...
        "spinner_screening": "scPDB дерекқорындағы 17 188 лиганд құрылымымен побиттік салыстыру жүргізілуде...",
        ...
        "top_match_instruction": "💡 *Студентке нұсқаулық:* Сіздің молекулаңыз осы ақуыздың нативті лигандына барынша ұқсас. scPDB архивінен `{pdb_id}` қапшығын алыңыз — онда молекулалық докинг жүргізу үшін карман координаттары дайындалған.",
    ...
    "English": {
        ...
        """,
        "docking_stage2_title": "🎯 Biological Target Screening via scPDB",
        ...
        "spinner_screening": "Performing bitwise comparison against 17,188 scPDB ligand structures...",
        ...
        "top_match_instruction": "💡 *Student Instruction:* Your molecule shares high structural similarity with the native ligand of this protein. Retrieve the folder `{pdb_id}` from the scPDB archive — it contains the pre-configured binding pocket coordinates for molecular docking.",
