...
LANGUAGES = {
    "Русский": {
        ...
        "project_start_hint": "👈 Для начала работы выберите молекулу в боковой панели (раздел «База kz» или поле ручного ввода SMILES)",
        ...
        "task_step_3": "3. В редакторе ниже **измените структуру молекулы** и проанализируйте изменения.",
    ...
    "Қазақша": {
        ...
        "project_start_hint": "👈 Жұмысты бастау үшін бүйірлік панельден молекуланы таңдаңыз («База kz» бөлімі немесе SMILES қолмен енгізу өрісі)",
        ...
        "task_step_3": "3. Төмендегі редакторда **молекула құрылымын өзгертіп**, өзгерістерді талдаңыз.",
    ...
    "English": {
        ...
        "project_start_hint": "👈 Select a molecule in the sidebar to start (via 'Catalog kz' or manual SMILES input)",
        ...
        "task_step_3": "3. **Modify the molecule structure** in the editor below and analyze the changes.",
